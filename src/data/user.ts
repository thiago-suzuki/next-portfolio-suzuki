...
export const paragraphsAboutUser: ParagraphsAboutUser = {
  one: {
    "pt-br": "Sou graduado em Bacharelado em Sistemas de Informação pela Universidade Santa Cecília e atualmente atuo como Desenvolvedor de Software Full Stack. Atualmente, estou cursando pós-graduação em Front-End pela Anhanguera. Tenho como foco a eficiência, a inovação e a qualidade em cada entrega, com forte interesse na resolução de problemas complexos por meio de soluções tecnológicas eficazes e bem estruturadas.",
    "es": "Soy graduado en Licenciatura en Sistemas de Información por la Universidade Santa Cecília y actualmente trabajo como Desarrollador de Software Full Stack. Actualmente estoy cursando un posgrado en Front-End en Anhanguera. Me enfoco en la eficiencia, la innovación y la calidad en cada entrega, con un fuerte interés en resolver problemas complejos mediante soluciones tecnológicas eficaces y bien estructuradas.",
    "en": "I hold a Bachelor's degree in Information Systems from Universidade Santa Cecília and currently work as a Full Stack Software Developer. I am currently pursuing a postgraduate degree in Front-End Development at Anhanguera. I focus on efficiency, innovation, and quality in every delivery, with a strong interest in solving complex problems through effective and well-structured technological solutions."
  },
  two: {
